...
const baseMaterialSchema = new Schema<IMaterial, Model<IMaterial, any, any>, any>(
	{
		...
		BPercent: { type: Number, trim: true, default: 10 },
		NPercent: { type: Number, trim: true, default: 15 },
		MNPercent: { type: Number, trim: true, default: 17 },
		MHPercent: { type: Number, trim: true, default: 20 },
		MCPercent: { type: Number, trim: true, default: 25 },
