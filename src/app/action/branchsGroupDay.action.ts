...
export const getChartBranchsGroupForDay = async (body: any) => {
	...
	let groupChart = { labels, datasets , title: `نمودار فروش ${branchs} در تاریخ های ${converted(days)}`, header: `جدول فروش ${branchs} در تاریخ های ${converted(days)}`}
	// حلقه زدن برروی اطلاعات دریافتی جهت اماده سازی اطلاعات در نمایش نمودار رادار
	...
	// اماده سازی اطلاعات نمایش نمودار جهت خروجی اصلی 
	let subGroupChart = { labels: allSubGroups, datasets: datasetBar, title: `نمودار فروش ${branchs} در تاریخ های ${converted(days)}`, header: `جدول فروش ${branchs} در تاریخ های ${converted(days)}` }
