      ...
      <section className="main-body-container rounded">
        <section className="d-flex justify-content-between align-items-center mt-1  mb-3 border-bottom pb-3" >
          <div className="col-md-6">
            <input type="text" onChange={(e: any) => setFilter(e.target.value)} placeholder='فیلتر براساس نام کالا تبدیلی، بارکد و یا سریال کالا تبدیلی ' className="form-control form-control-sm" />
          </div>
          ...
          <table className="table table-bordered table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>نام کالا تبدیلی</th>
                <th>دسته بندی</th>
                <th>بارکد کالا تبدیلی</th>
                <th>آخرین قیمت</th>
