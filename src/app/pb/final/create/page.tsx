...
export default function CreatePackagePage() {
  ...
  const handleCreatePackage = async (obj: any) => {
    if (items?.length < 2) { toast.warning('برای تعریف کالا حداقل دو قلم کالا باید انتخاب شود'); return }
    ...
    <>
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item"> <Link href="/pb/final"> لیست کالا نهایی</Link> </li>
      ...
      <section className="main-body-container rounded">
        <section className="row">
          ...
          <div className="col-12 col-md-3 px-1">
            <label className='my-1' htmlFor="">بارکد یا نام کالا  </label>
          ...
          <div className="col-12 col-md-3 px-1">
            <label className='my-1' htmlFor=""> مقدار مصرفی kg </label>
            {/* float input */}
            <input type="text" inputMode="decimal" value={percent} className="form-control form-control-sm"
              onChange={(e) => {
                let v: any = e.target.value.replace(',', '.');
