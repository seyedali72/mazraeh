...
export default function CreateProductPage() {
  ...
  const handleCreateProduct = async (obj: any) => {
    if (items?.length < 2) { toast.warning('برای تعریف کالا حداقل دو ماده اولیه باید انتخاب شود'); return }
    ...
    <>
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active" aria-current="page"> تعریف کالای میانی جدید </li>
        </ol>
      </nav>
      {edited &&
      ...
      <form action="post" onSubmit={handleSubmit(handleCreateProduct)} method='Post'>
