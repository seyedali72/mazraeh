...
import { getChartBranchCategoriesForTotal } from "@/app/action/branchsCategoryTotal.action";

export default function CategoryAndProductTotalCmp({ requestData, allProduct }: any) {
    ...
    const handleCategoryAndProduct = async () => {
        ...
        let res = await getChartBranchCategoriesForTotal(requestData)
