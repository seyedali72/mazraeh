...
import { getChartBranchsGroupForTotal } from "@/app/action/branchsGroupTotal.action";

export default function GroupAndSubGroupTotalCmp({ requestData, allSubGroup }: any) {
    ...
    const handleGroupAndSubGroup = async () => {
        ...
        let res = await getChartBranchsGroupForTotal(requestData)
